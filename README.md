...
```powershell
go run ./cmd/live-handoff-verify -config configs/live.local.yaml -plan-file artifacts/live-order-plan.json -readiness-file artifacts/live-readiness.json -decision-id risk_decision_live_001
```
...
make live-handoff-verify CONFIG=configs/live.local.yaml LIVE_PLAN_FILE=artifacts/live-order-plan.json LIVE_READINESS_FILE=artifacts/live-readiness.json LIVE_DECISION_ID=risk_decision_live_001
