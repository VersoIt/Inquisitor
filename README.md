...
Run a bounded paper execution cycle. Each cycle checks exits first, records at most one exit or one entry, and skips entry while any active open position remains:
